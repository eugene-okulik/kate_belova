...
from test_api_belova.schemas import ResponseObjectsSchema
...
class GetObjects(BaseAPI):
    ...
    def assert_has_objects(self, min_count: int = 1):
        self.object_data = ResponseObjectsSchema(**self.json)
...
class GetObject(BaseAPI):
    ...
    @allure.step('Send GET request to get object by its ID')
